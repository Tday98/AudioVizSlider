...
public class PlayerController implements Initializable {
    ...
    private void handleReady() {
        ...
        double ss = duration.toSeconds();
        lengthText.setText(oneDecimal.format(ss));
    ...
    private void setCurrentTime(double seconds) {
        setCurrentTime(seconds, false);
    }
    
    private void setCurrentTime(double seconds, boolean seeking) {
        currentText.setText(oneDecimal.format(seconds));
        if (!sliding) {
    ...
    private void handleDragEnd(MouseEvent event) {
        if (mediaPlayer != null) {
            sliding = false;
            mediaPlayer.seek(Duration.seconds(timeSlider.valueProperty().doubleValue()));
        }
    }
}
